...
Publiczny katalog 12 ofert jest wydany. Najbliższy maintenance deadline to freshness recheck 31.08.2026 dla Nest, Pekao, mBank, Kraken oraz landing gates Pekao i Nest. Aktywnym etapem jest v0.8.0 Alternative Comparison & Product Identity Mapping: zaakceptowane mapowanie i kontrakt mBank mają lokalny bounded UI prototype oczekujący na Founder Review; nie jest on podłączony do homepage ani produkcji. Operacje afiliacyjne i tracking pozostają równoległym strumieniem bez wpływu na decyzję produktu. Prywatna beta została przesunięta do kamienia milowego 1.0 i przed stabilnym wydaniem użyje oznaczenia `v1.0-beta`.
