...
Publiczny katalog 12 ofert jest wydany. Najbliższy maintenance deadline to freshness recheck 31.08.2026 dla Nest, Pekao, mBank, Kraken oraz landing gates Pekao i Nest. Aktywnym etapem jest v0.8.0 Alternative Comparison & Product Identity Mapping: lokalny bounded UI prototype mBank przeszedł Founder Review i UX density pass, pozostaje poza homepage i produkcją oraz jest gotowy do kolejnego Founder Review. Operacje afiliacyjne i tracking pozostają równoległym strumieniem bez wpływu na decyzję produktu. Prywatna beta została przesunięta do kamienia milowego 1.0 i przed stabilnym wydaniem użyje oznaczenia `v1.0-beta`.
